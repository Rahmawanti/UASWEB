...
<head>
	...
	<title>Input Data Minuman</title>
...
<body>
	...
	<div class="container">
			<!-- add/edit form modal -->
			<center>
            <h5 class="modal-title" id="exampleModalLabel">Tambah Data Minuman <i class="fa fa-user-circle-o" aria-hidden="true"></i></h5>
        </center>

        <form action="config/minuman.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_minuman" required="required">
                    </div>
                </div>
                <div class="form-group">
