...
<body>
	...
	<div class="container">
        ...
        <!-- add/edit form modal -->
        <center>
            <h5 class="modal-title" id="exampleModalLabel">Edit Data Makanan <i class="fa fa-user-circle-o" aria-hidden="true"></i></h5>
        </center>

        <form id="addform" method="POST" action="config/edit_makanan.php">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_makanan" value="<?php echo $nama_makanan; ?>" required="required">
                    </div>
                </div>
                <div class="form-group">
