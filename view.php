...
<body>
    <div class="container">
         ...
         <div class="row mb-3">
            <div class="col-3">
                <a href="tambah_makanan.php" class="btn btn-primary">Add New <i class="fa fa-user-circle-o"></i></a>
            </div>
            <div class="col-9">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle"><?php echo $nama_makanan; ?></td>
                        <td class="align-middle"><?php echo $harga; ?></td>
                        <td class="align-middle"><?php echo $deskripsi; ?></td>
                        <td class="align-middle">
                            <form action="edit_makanan.php" method="POST">
                                <input type="hidden" name="no_makanan" value="<?php echo $no_makanan; ?>" />
                                <input type="hidden" name="nama_makanan" value="<?php echo $nama_makanan; ?>" />
                        ...
                        <!-- form delete -->
                        <td class="align-middle">
                            <form action="config/hapus_makanan.php" method="POST">
                                <input type="hidden" name="no_makanan" value="<?php echo $no_makanan; ?>" />
